...
function renderFlashes(data){
  ...
  // ========== NUEVO CÓDIGO: DETENER VIDEOS AL CLIC FUERA ==========
  document.addEventListener('click', function(event) {
    // Verificar si el clic NO fue dentro de ningún contenedor de video
